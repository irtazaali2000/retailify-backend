...
class NoonSpider(Spider):
    ...
    categories = {
        ...
        'Men & Women Watches': {
            ...
            "Men Watches": 'https://www.noon.com/_svc/catalog/api/v3/u/fashion/boys-31221/boys-watches/?limit=50&originalQuery=Fashion&page={}&page={}&q=Fashion&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc',
        },
        ...
        'Books': {
            'Children Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/childrens-books/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            'Fiction Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/fiction-F/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            'Education & Reference Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/reference-G/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            'Health, Mind & Body Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/health-and-personal-development/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            'Photography & Art Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/arts-architecture-and-photography/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            "Business & Investment Books": "https://www.noon.com/_svc/catalog/api/v3/u/books/business-and-finance/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            "Cooking & Food Books": "https://www.noon.com/_svc/catalog/api/v3/u/books/lifestyle-sport-and-leisure/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
            'Cooking & Food Books': "https://www.noon.com/_svc/catalog/api/v3/u/books/food-drink/?limit=50&originalQuery=Books&page={}&page={}&q=Books&searchDebug=false&sort%5Bby%5D=popularity&sort%5Bdir%5D=desc",
