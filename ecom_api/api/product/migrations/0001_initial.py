# Generated by Django 4.2.16 on 2024-09-19 09:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MyPrice', models.DecimalField(blank=True, decimal_places=2, max_digits=19, null=True)),
                ('ModelNumber', models.CharField(default='', max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ModelNumber', models.CharField(blank=True, default='', max_length=255, null=True)),
                ('RatingValue', models.DecimalField(decimal_places=2, default=0, max_digits=19)),
                ('CatalogueCode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.catalogue')),
                ('CategoryCode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='product.category')),
            ],
        ...
        migrations.CreateModel(
            name='OurStoreProductAttribute',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('AttributeName', models.CharField(max_length=255)),
                ('AttributeValue', models.CharField(max_length=255)),
                ('ProductCode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.ourstoreproduct')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
