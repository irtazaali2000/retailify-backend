...
class ProductUploadV1(CreateAPIView):
    ...
    def is_update(self, instance, data):
        ...
        if 'RatingValue' in data and float(data['RatingValue']) != float(instance.RatingValue):
            ...
            return True
        # if 'MainImage' in data and data['MainImage'] != instance.MainImage:
        #     LOGGER.info(f"Image Updated from {instance.MainImage} to {data['MainImage']}!")
        #     return True
